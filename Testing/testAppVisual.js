...
(async function testAppVisual() {
    ...
    try{
        ...
        let visBtn = await driver.findElement(By.xpath('/html/body/app-root/app-admin-dashboard-page/app-content/div/div/div[1]/table[4]/tbody/tr[' + count + ']/td[8]/button[2]/i'));
        await driver.actions()
            .scroll(0,0,0,0, visBtn)
            .perform();
