...
@Component({
  selector: 'app-faculty-toolbox-page',
  templateUrl: './faculty-toolbox-page.component.html',
  styleUrls: ['./faculty-toolbox-page.component.css'],
    imports: [
        HeaderComponent,
        FooterComponent,
        ContactComponent,
...
export class FacultyToolboxComponent {
  headerLinks: HeaderLinkItem[] = [
    { title: 'Exact Plan', link: 'exact'},
    { title: 'Faculty Toolbox', link: 'exact/faculty-toolbox'},
  ];
}
